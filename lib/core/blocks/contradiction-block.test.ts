...
import { ContradictionBlockData, ContradictionType } from './contradiction-block';

describe('ContradictionBlockData', () => {
...
This is the explanation.`;
      ...
      const result = ContradictionBlockData.fromMarkdown(blockRaw);
...
Test explanation`;
  ...
  describe('getText', () => {
    it('should return formatted text content', () => {
      const block = new ContradictionBlockData('test-id', 'Main content', {
        choices: [
          { key: 'a', content: 'First choice' },
          { key: 'b', content: 'Second choice' },
        ],
    ...
    it('should handle empty content', () => {
      const block = new ContradictionBlockData('test-id', '', {

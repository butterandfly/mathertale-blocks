...
export class SingleChoiceBlockData implements BlockSchema {
...
---`;
  ...
  static validate(block: SingleChoiceBlockData): void {
   ...
   * ```
   */
  static fromMarkdown(block: MarkdownBlock): SingleChoiceBlockData {
    ...
    const newBlock = new SingleChoiceBlockData(
      block.id,

...
describe('SingleChoiceBlockData', () => {
...
The explanation text.`;
      ...
      const block = SingleChoiceBlockData.fromMarkdown(markdownBlock);
...
The explanation text.`;
  ...
  describe('validate method', () => {
    it('should throw error if choices is empty', () => {
      const block = new SingleChoiceBlockData('test-id', 'Test content', {
        choices: [],
        answer: 'a',
        explanation: 'Explanation',
      });

      expect(() => SingleChoiceBlockData.validate(block)).toThrow('Choices cannot be empty');
    });
    ...
    it('should throw error if answer is empty', () => {
      ...
      expect(() => SingleChoiceBlockData.validate(block)).toThrow('Answer is required');
    });
